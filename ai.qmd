...
contained not only contact information, but also distances and angles.

![High-resolution contact maps of 6MSP. From
...
Bassically, Alphafold implemented some improvements in recently used approaches,
creating a new whole pipeline. Instead of create contact maps from the alingment
to fold the structure they used a MRF unit (Markov Random Field) to extract in
advance the main features of the MSA and process into a multilayer NN called
ResNet that provide the distant map and other information that you can use to
create the structure and then improve it by energy minimization and substitution
of portions with a selected DB of protein fragments.
...
like the prediction of protein complexes \[@evans], which was actually mentioned
first on
...
](pics/machine_fold.png)](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8197379/pdf/ijms-22-05553.pdf)
...
](pics/alphafols2.png "Alphafold2")](https://www.blopig.com/blog/2021/07/alphafold-2-is-here-whats-behind-the-structure-prediction-miracle/)
...
+---------------+-------------------+-------------------------------------------------------+
| DisCovEr      | @bhattacharya2022 | <https://github.com/Bhattacharya-Lab/DisCovER>        |
+---------------+-------------------+-------------------------------------------------------+
| trRosetta     | @yang2020         | <https://robetta.bakerlab.org/>                       |
+---------------+-------------------+-------------------------------------------------------+
| Alphafold     | @senior2020       | <https://github.com/deepm                             |
|               |                   | ind/deepmind-research/tree/master/alphafold_casp13aa> |
+---------------+-------------------+-------------------------------------------------------+
| RoseTTAfold   | @baek2021         | <https://robetta.bakerlab.org/>                       |
+---------------+-------------------+-------------------------------------------------------+
| Alphafold2    | @jumper2021\      | [https://git                                          |
|               | & @mirdita2022    | hub.com/deepmind/alphafold](https://githu%20b.com/dee |
|               |                   | pmind/alphafoldhttps://github.com/deepmind/alphafold) |
|               |                   |                                                       |
